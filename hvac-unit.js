...
var hvac_unit_data_1 = require("./hvac-unit-data");
...
var importData = function () { return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_b) {
        switch (_b.label) {
            case 0:
                _b.trys.push([0, 2, , 3]);
                requests = hvac_unit_data_1.items.map(function (item) { return __awaiter(void 0, void 0, void 0, function () {
                    return __generator(this, function (_a) {
                        return [2 /*return*/, axios_1.default.post("https://builder.io/api/v1/write/hvac-unit", {
                                name: item.name,
                                data: item.data,
                                published: "published"
                            }, {
            ...
            case 1:
                ...
                responses.forEach(function (res, index) {
                    console.log("\u2705 Item ".concat(index + 1, " imported:"), res === null || res === void 0 ? void 0 : res.data);
                });
                return [3 /*break*/, 3];
            case 2:
                error_1 = _b.sent();
